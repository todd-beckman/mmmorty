...
import (
	...
	"github.com/todd-beckman/mmmorty/roleplugin"
...
func init() {
	...
	flag.BoolVar(&enableRoles, "roles", true, "Whether to enable setting roles")
...
func main() {
	...
	if (discordEmail != "" && discordPassword != "") || discordToken != "" {
		...
		if enableRoles {
			bot.RegisterPlugin(discord, roleplugin.New())
		}
		if enableWars {
